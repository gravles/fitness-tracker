...
import { X, Sparkles, Rocket, Zap, Bug, Dumbbell, Brain, Smartphone, Calendar, Bell, Sun, Moon, Dna, Apple, BarChart2, BookOpen, Palette, Languages, Link2, Save, Users, Trophy, Gift, Image as ImageIcon } from 'lucide-react';
    ...
    const changes = [
        {
            ...
            features: [
                ...
                { icon: <Sparkles className="w-4 h-4" style={{ color: 'var(--color-gold)' }} />, text: "Send one-tap encouragement 💪 and get alerts when your partner's streak is at risk." },
                ...
                { icon: <Trophy className="w-4 h-4" style={{ color: 'var(--color-gold)' }} />, text: "Group challenges (2–8 people): logging streaks, protein days, or workout counts on an anonymous leaderboard." },
                { icon: <ImageIcon className="w-4 h-4" style={{ color: 'var(--color-primary)' }} />, text: "Progress photos can now be picked from your phone's gallery, with automatic compression." },
            ]
        },
        {
